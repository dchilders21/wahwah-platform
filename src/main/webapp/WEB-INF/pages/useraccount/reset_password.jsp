    ...
    <section class="auth-form">
        <div class="inner-wrapper">
            ...
            <c:choose>
                    ...
                    <form action="" method="post" id="_form" class="form-horizontal">
                        ...
                        <fieldset>
                            ...
                            <div class="instructions">
                                <p>Enter your new password in the form below to reset your password</p>
                            </div>

                            <div class="control-group required">

                                <div class="controls">
                                    <input id="id_password" type="password" name="password" maxlength="254" placeholder="New Password"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group required">
                                <div class="controls">
                                    <input type="password" name="confirmPassword" id="id_password_confirm" placeholder="New Password Confirmation" />
                            ...
                            <div class="form-actions">
                                <div id="center-submit"><input class="btn btn-primary" type="submit" value="Reset Password" /></div>
                            </div>
                        </fieldset>
                    </form>
                ...
                <c:otherwise>
                    <div class="instructions">
                        <p>Your password cannot be reset at this time. Please try again later or contact Red Panda Platform support.</p>
                    </div>
                </c:otherwise>
            </c:choose>

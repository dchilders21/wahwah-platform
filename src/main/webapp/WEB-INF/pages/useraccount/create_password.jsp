    ...
    <section class="auth-form">
        <div class="inner-wrapper">
            ...
            <c:choose>
                    ...
                    <form action="" method="post" id="_form" class="form-horizontal">
                        ...
                        <fieldset>
                            ...
                            <div class="instructions">
                                <p>Enter your password in the form below to create your new password</p>
                            </div>
                            ...
                            <div class="control-group required">
                                ...
                                <div class="controls">
                                    <input id="id_password" type="password" name="password" maxlength="254" />
                                </div>
                            </div>
                            ...
                            <div class="control-group required">
                                <label class="control-label" for="id_password_confirm">New Password Confirmation</label>

                                <div class="controls">
                                    <input type="password" name="confirmPassword" id="id_password_confirm" />
                ...
                <c:otherwise>
                    <div class="instructions">
                        <p>Your password cannot be created at this time. Please try again later or contact Red Panda Platform support.</p>
                    </div>
                </c:otherwise>
            </c:choose>

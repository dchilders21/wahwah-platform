...
<div class="container auth">
    ...
    <section class="auth-form">
        ...
        <div class="inner-wrapper">
            ...
            <h2>${canResetPassword ? "Password Reset Completed Successfully" : "Password Reset Failed"}</h2>
                    ...
                    <p>
                        ...
                        <c:choose>
                            <c:when test="${canResetPassword}">
                                <p>You have successfully reset your password. Please <a href="${pageContext.request.contextPath}/useraccount/login/">login</a> to continue.</p>
                            </c:when>
                            <c:otherwise>

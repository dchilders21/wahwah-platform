...
<div class="container auth">
    ...
    <section class="auth-form">
        ...
        <div class="inner-wrapper">
            ...
            <h2>${canCreatePassword ? "Password Created Successfully" : "Password Created Failed"}</h2>
                    ...
                    <p>
                        ...
                        <c:choose>
                            <c:when test="${canCreatePassword}">
                                <p>You have successfully created your password. Please <a href="${pageContext.request.contextPath}/useraccount/login/">login</a> to continue.</p>
                            </c:when>
                            <c:otherwise>

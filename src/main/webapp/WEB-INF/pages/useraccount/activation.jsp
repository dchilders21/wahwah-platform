...
<div class="container auth">
    ...
    <section class="auth-form">
        ...
        <div class="inner-wrapper">
            ...
            <h2>${didActivate ? "Activation Successful" : "Activation Failed"}</h2>
            <fieldset class="no-form">
                <div class="instructions">
                    <p>
                        <c:choose>
                            <c:when test="${didActivate}">
                                <p>You have activated your user account. Please <a href="${pageContext.request.contextPath}/useraccount/login/">login</a> to continue.</p>
                            </c:when>
                            <c:otherwise>
                                <p>Your user account cannot be activated at this time. Please try again later or contact Red Panda Platform support.</p>
                            </c:otherwise>
                        </c:choose>
                    </p>
                </div>
